...
public class Start {
    ...
    static App app = null;
    static LoginWindow login = null; //initializing login window variable
...
//            app = new App(true); //app will no longer start automatically, users must sign in first.
            //Builds login window frame
