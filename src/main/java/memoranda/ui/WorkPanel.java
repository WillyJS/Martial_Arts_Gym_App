...
public class WorkPanel extends JPanel {
	...
	void jbInit() throws Exception {
		...
		agendaB.setText(Local.getString("Dojo"));
		...
		eventsB.setText(Local.getString("Sessions"));
