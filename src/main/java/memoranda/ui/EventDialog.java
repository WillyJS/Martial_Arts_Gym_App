...
public class EventDialog extends JDialog implements WindowListener {
    ...
    // Add label for trainer text field
    JLabel lbltrainer = new JLabel();
    public JTextField textField = new JTextField();
    // Create new textfield for trainers
    public JTextField trainerField = new JTextField();
    // Create Room Number drop down US70 PD
    JLabel lblRoom = new JLabel();
    public JSpinner roomSpinner = new JSpinner(new SpinnerNumberModel(1, 1, 4, 1));
    // Add an add student text field US70 PD
    JLabel lblstudentJLabel = new JLabel();
    public JTextField studentField = new JTextField();
    // Added Class Level spinner US70 PD
    JLabel lblLevel = new JLabel();
    String[] level = { "Beg.", "Adv." };
    public JSpinner levelSpinner = new JSpinner(new SpinnerListModel(level));
    // Added Private/public Spinner US70 PD
    JLabel lblTypeClass = new JLabel();
    String[] typeClass = { "Public", "Private" };
    public JSpinner typeSpinner = new JSpinner(new SpinnerListModel(typeClass));
    ...
    void jbInit() throws Exception {
        ...
        header.setText(Local.getString("Session"));
        header.setIcon(new ImageIcon(
                main.java.memoranda.ui.EventDialog.class.getResource("/ui/icons/event48.png")));
        ...
        lblText.setText(Local.getString("Session Name"));
        ...
        // Set up trainer label US29
        lbltrainer.setText(Local.getString("Trainer"));
        lbltrainer.setMinimumSize(new Dimension(120, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.gridwidth = 2;
        ...
        // Add trainer textfield to the event panel US29
        trainerField.setMinimumSize(new Dimension(375, 20));
        trainerField.setPreferredSize(new Dimension(375, 20));
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 2;
        gbc.gridwidth = 6;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        eventPanel.add(trainerField, gbc);

        // Setup Level spinner US70 PD
        // Setup Level Label
        lblLevel.setText(Local.getString("Class Belt Level"));
        lblLevel.setMinimumSize(new Dimension(120, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.gridwidth = 2;
        gbc.insets = new Insets(5, 10, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(lblLevel, gbc);

        // Setup Level Spinner
        levelSpinner.setPreferredSize(new Dimension(60, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 4;
        gbc.gridy = 3;
        gbc.insets = new Insets(10, 0, 5, 0);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(levelSpinner, gbc);

        // Setup Room spinner US70 PD
        // Setup room number Label
        /**
         * lblRoom.setText(Local.getString("Room Number")); lblRoom.setMinimumSize(new
         * Dimension(120, 24)); gbc = new GridBagConstraints(); gbc.gridx = 0; gbc.gridy
         * = 4; gbc.gridwidth = 2; gbc.insets = new Insets(5, 10, 5, 10); gbc.anchor =
         * GridBagConstraints.WEST; eventPanel.add(lblRoom, gbc);
         * 
         * // Setup Room Spinner roomSpinner.setPreferredSize(new Dimension(60, 24));
         * gbc = new GridBagConstraints(); gbc.gridx = 4; gbc.gridy = 4; gbc.insets =
         * new Insets(10, 0, 5, 0); gbc.anchor = GridBagConstraints.WEST;
         * eventPanel.add(roomSpinner, gbc);
         */
        // Setup Private/Public spinner US70 PD
        // Setup room number Label
        lblTypeClass.setText(Local.getString("Class Type"));
        lblTypeClass.setMinimumSize(new Dimension(120, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.gridwidth = 2;
        gbc.insets = new Insets(5, 10, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(lblTypeClass, gbc);

        // Setup Private/Public Spinner
        typeSpinner.setPreferredSize(new Dimension(60, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 4;
        gbc.gridy = 5;
        gbc.gridwidth = 4;
        gbc.insets = new Insets(10, 0, 5, 0);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(typeSpinner, gbc);

        // Setup Add Student US70 PD
        // Setup add Student Label
        lblstudentJLabel.setText(Local.getString("Add Student"));
        lblstudentJLabel.setMinimumSize(new Dimension(120, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 6;
        gbc.gridwidth = 2;
        gbc.insets = new Insets(5, 10, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        eventPanel.add(lblstudentJLabel, gbc);

        // Setup add student textfield
        roomSpinner.setPreferredSize(new Dimension(60, 24));
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 6;
        gbc.gridwidth = 6;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        eventPanel.add(studentField, gbc);

        // Build RepeatPanel
        repeatBorder = new TitledBorder(BorderFactory.createLineBorder(Color.gray, 1),
                Local.getString("Repeat"));
        ...
        setStartDateB.setIcon(new ImageIcon(
                main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/calendar.png")));
        ...
        // Remove Repeatable sessions US70 PD
