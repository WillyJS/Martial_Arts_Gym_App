...
public class PreferencesDialog extends JDialog {
    ...
    // JLabel jLabel1 = new JLabel(); //Disabled Feature (Look and Feel)
    ...
    // JRadioButton closeHideRB = new JRadioButton(); //Disabled Feature (Look and
    // Feel)
    ...
    void jbInit() throws Exception {
        ...
        // Build Tab1
        // jLabel1.setHorizontalAlignment(SwingConstants.RIGHT); //Disabled Feature
        // (Look and Feel)
        // .setText(Local.getString("Window minimize action:")); //Disabled Feature
        // (Look and Feel)
        ...
        // This disables the Minimize vs Hide / Close vs Hide preferences as the
        // functionality was built into the UI options
        // (Look and Feel Features)
        /*
         * GeneralPanel.add(jLabel1, gbc); minGroup.add(minTaskbarRB);
         * minTaskbarRB.setSelected(true);
         * minTaskbarRB.setText(Local.getString("Minimize to taskbar z"));
         * minTaskbarRB.addActionListener(new java.awt.event.ActionListener() { public
         * void actionPerformed(ActionEvent e) { minTaskbarRB_actionPerformed(e); } });
         * gbc = new GridBagConstraints(); gbc.gridx = 1; gbc.gridy = 0; gbc.insets =
         * new Insets(10, 0, 0, 10); gbc.anchor = GridBagConstraints.WEST;
         * GeneralPanel.add(minTaskbarRB, gbc); minGroup.add(minHideRB);
         * minHideRB.setText(Local.getString("Hide")); minHideRB.addActionListener(new
         * java.awt.event.ActionListener() { public void actionPerformed(ActionEvent e)
         * { minHideRB_actionPerformed(e); } }); gbc = new GridBagConstraints();
         * gbc.gridx = 1; gbc.gridy = 1; gbc.insets = new Insets(2, 0, 0, 10);
         * gbc.anchor = GridBagConstraints.WEST; GeneralPanel.add(minHideRB, gbc);
         * jLabel2.setHorizontalAlignment(SwingConstants.RIGHT);
         * jLabel2.setText(Local.getString("Window close action:")); gbc = new
         * GridBagConstraints(); gbc.gridx = 0; gbc.gridy = 2; gbc.insets = new
         * Insets(2, 10, 0, 15); gbc.anchor = GridBagConstraints.EAST;
         * GeneralPanel.add(jLabel2, gbc); closeGroup.add(closeExitRB);
         * closeExitRB.setSelected(true);
         * closeExitRB.setText(Local.getString("Close and exit"));
         * closeExitRB.addActionListener(new java.awt.event.ActionListener() { public
         * void actionPerformed(ActionEvent e) { closeExitRB_actionPerformed(e); } });
         * gbc = new GridBagConstraints(); gbc.gridx = 1; gbc.gridy = 2; gbc.insets =
         * new Insets(2, 0, 0, 10); gbc.anchor = GridBagConstraints.WEST;
         * GeneralPanel.add(closeExitRB, gbc);
         * 
         * closeGroup.add(closeHideRB); closeHideRB.setText(Local.getString("Hide"));
         * closeHideRB.addActionListener(new java.awt.event.ActionListener() { public
         * void actionPerformed(ActionEvent e) { closeHideRB_actionPerformed(e); } });
         */
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 3;
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.insets = new Insets(2, 10, 5, 15);
        gbc.anchor = GridBagConstraints.EAST;
        ...
        lfSystemRB.setText(Local.getString("Classic"));
        ...
        lfJavaRB.setText(Local.getString("Normal"));
        // lfGroup.add(lfCustomRB);

        // Adding other look and Feel buttons to group US40 PD
        ...
        gbc.gridx = 1;
        gbc.gridy = 5;
        gbc.insets = new Insets(2, 20, 5, 10);
        gbc.anchor = GridBagConstraints.WEST;
        ...
        // gbc.gridx = 1;
        // gbc.gridy = 6;
        // gbc.insets = new Insets(7, 20, 5, 10);
        // gbc.anchor = GridBagConstraints.WEST;
        ...
        // US40 Remove resource panel PD
        // Build Tab2
        /*
         * rstPanelBorder = BorderFactory.createEmptyBorder(5, 5, 5, 5);
         * resourceTypePanel.setBorder(rstPanelBorder);
         * resourcePanel.add(resourceTypePanel, BorderLayout.CENTER); rsbpBorder = new
         * TitledBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5),
         * Local.getString("Web browser executable"));
         * rsBottomPanel.setBorder(rsbpBorder); jLabel5.setText(Local.getString("Path")
         * + ":"); gbc = new GridBagConstraints(); gbc.gridx = 0; gbc.gridy = 0;
         * gbc.insets = new Insets(0, 5, 0, 5); gbc.anchor = GridBagConstraints.WEST;
         * rsBottomPanel.add(jLabel5, gbc); browserPath.setPreferredSize(new
         * Dimension(250, 25)); gbc = new GridBagConstraints(); gbc.gridx = 1; gbc.gridy
         * = 0; gbc.insets = new Insets(0, 5, 0, 10); gbc.anchor =
         * GridBagConstraints.WEST; gbc.fill = GridBagConstraints.HORIZONTAL;
         * rsBottomPanel.add(browserPath, gbc);
         * browseB.setText(Local.getString("Browse")); browseB.setPreferredSize(new
         * Dimension(110, 25)); browseB.addActionListener(new
         * java.awt.event.ActionListener() { public void actionPerformed(ActionEvent e)
         * { browseB_actionPerformed(e); } }); gbc = new GridBagConstraints(); gbc.gridx
         * = 2; gbc.gridy = 0; // gbc.insets = new Insets(0, 0, 0, 0); gbc.anchor =
         * GridBagConstraints.EAST; rsBottomPanel.add(browseB, gbc);
         * 
